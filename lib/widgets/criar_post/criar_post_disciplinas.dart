...
class CriarPostDisciplinas extends StatefulWidget {
  ...
  @override
  State<CriarPostDisciplinas> createState() => _CriarPostDisciplinasState();
}

class _CriarPostDisciplinasState extends State<CriarPostDisciplinas> {
  @override
  void initState() {
    super.initState();
    getNickname();
                  ...
                  suffixIcon: IconButton(
                        onPressed: () async {
                          if (post.text.isNotEmpty) {
                            final postDoc = storeMessage.collection("postDisciplinas").doc();
                            await postDoc.set({
                              "post": post.text.trim(),
                              "time": DateTime.now(),
                              "nickname": nickname,
