...
import '../../models/show messages/show_messages_avaliacoes.dart';
import '../../models/show messages/show_messages_estagio.dart';

class CriarPostEstagio extends StatefulWidget {
  ...
  @override
  State<CriarPostEstagio> createState() => _CriarPostEstagioState();
}

class _CriarPostEstagioState extends State<CriarPostEstagio> {
  @override
  void initState() {
    super.initState();
    getNickname();
                  ...
                  suffixIcon: IconButton(
                        onPressed: () async {
                          if (post.text.isNotEmpty) {
                            final postDoc = storeMessage.collection("postEstagio").doc();
                            await postDoc.set({
                              "post": post.text.trim(),
                              "time": DateTime.now(),
                              "nickname": nickname,
