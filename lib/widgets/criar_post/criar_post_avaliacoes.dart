...
class CriarPostAvaliacoes extends StatefulWidget {
  ...
  @override
  State<CriarPostAvaliacoes> createState() => _CriarPostAvaliacoesState();
}

class _CriarPostAvaliacoesState extends State<CriarPostAvaliacoes> {
  @override
  void initState() {
    super.initState();
    getNickname();
                  ...
                  suffixIcon: IconButton(
                        onPressed: () async {
                          if (post.text.isNotEmpty) {
                            final postDoc = storeMessage.collection("postAvaliacoes").doc();
                            await postDoc.set({
                              "post": post.text.trim(),
                              "time": DateTime.now(),
                              "nickname": nickname,
