...
import 'package:info_unity_study/widgets/tags_widgets/tags_widget_palestras.dart';

class ShowMessagesPalestras extends StatefulWidget {
  final String? tagText;
  const ShowMessagesPalestras({
    Key? key,
    this.tagText,
  }) : super(key: key);

  @override
  State<ShowMessagesPalestras> createState() => _ShowMessagesPalestrasState();
}

class _ShowMessagesPalestrasState extends State<ShowMessagesPalestras> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("postPalestras")
          .orderBy("time")
          .snapshots(),
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  TagsWidgetPalestras(postId: document["id"]),
                                ],
                              ),
                            ),
                          ),
