...
import 'package:info_unity_study/widgets/tags_widgets/tags_widget_estagio.dart';

class ShowMessagesEstagio extends StatefulWidget {
  final String? tagText;
  const ShowMessagesEstagio({
    Key? key,
    this.tagText,
  }) : super(key: key);

  @override
  State<ShowMessagesEstagio> createState() => _ShowMessagesEstagioState();
}

class _ShowMessagesEstagioState extends State<ShowMessagesEstagio> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("postEstagio")
          .orderBy("time")
          .snapshots(),
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  TagsWidgetEstagio(postId: document["id"]),
                                ],
                              ),
                            ),
                          ),
