...
class ShowMessagesAvaliacoes extends StatefulWidget {
  ...
  const ShowMessagesAvaliacoes({
    Key? key,
    this.tagText,
  }) : super(key: key);

  @override
  State<ShowMessagesAvaliacoes> createState() => _ShowMessagesAvaliacoesState();
}

class _ShowMessagesAvaliacoesState extends State<ShowMessagesAvaliacoes> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("postAvaliacoes")
          .orderBy("time")
          .snapshots(),
