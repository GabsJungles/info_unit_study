...
import 'package:info_unity_study/widgets/tags_widgets/tags_widget_calendar.dart';

class ShowMessagesCalendar extends StatefulWidget {
  final String? tagText;
  const ShowMessagesCalendar({
    Key? key,
    this.tagText,
  }) : super(key: key);

  @override
  State<ShowMessagesCalendar> createState() => _ShowMessagesCalendarState();
}

class _ShowMessagesCalendarState extends State<ShowMessagesCalendar> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("postCalendar")
          .orderBy("time")
          .snapshots(),
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  TagsWidgetCalendar(postId: document["id"]),
                                ],
                              ),
                            ),
                          ),
